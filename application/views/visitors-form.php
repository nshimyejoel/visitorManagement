...
<div class="row form-group">
<div class="col col-md-3">
<?php echo form_label('Room no.', 'apartmentno'); ?> 
</div>
<div class="col-12 col-md-9">
<?php echo form_input(['name' => 'apartment', 'id' => 'apartment', 'value' => set_value('apartment'), 'class' => 'form-control', 'placeholder' => 'Room no.']); ?> 
